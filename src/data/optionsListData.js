...
const tuningOps = ["tuneTitle", "standard", "NewST", "fifths", "bassStd", "drop d", "DADGAD", "ukelele", "stdRev", "custom"];
...
export default[
    ...
    {name: "ukelele", content: "standard ukelele", children: [], function: "T=G C E A X X"},
